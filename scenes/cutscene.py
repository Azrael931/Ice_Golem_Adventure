...
MONOLOGUE = [
    ...
    "Toi seul peux resister a sa chaleur toxique grace a un bouclier bleute inspire de la couche d'ozone",
    "une protection celeste qui filtre les fumees toxiques et affaiblit le monstre de pollution..",
    "",
