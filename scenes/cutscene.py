...
MONOLOGUE = [
    ...
    "Son corps est forme de fumees noires, de CO2, ",
    "de methane, d'oxydes d'azote et d'autres substances",
    ...
    "S'il devient trop puissant, il pourrait detruire des ecosystemes entiers",
    " ainsi que provoquer la disparition de nombreuses especes",
    "On le surnomme Smog.",
    "",
    ...
    "Toi seul peux resister a sa chaleur toxique grace a un bouclier bleu inspire de ",
    "la couche d'ozone, une protection celeste qui filtre les fumees toxiques ",
...
CINEMATIQUE_NIVEAU_1_FIN = [
    ...
    "De plus les humain continu de polluer la planete ",
    "Avec leur voitures ce qui t'affaiblies",
    "C'est l'effet de serre. Notre monde fond du a la betise humaine",
