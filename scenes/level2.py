...
class Game:
    ...
    def run(self):
        ...
        while running:
            ...
            print("Joueur : x={}, y={}          ".format(int(self.player.position[0]), int(self.player.position[1])),
                  end="\r")
            ...
            while n < len(self.statues):
                ...
                if not self.statues[n]["active"] and statue_mod.est_proche(self.player.hitbox,
                                                                           self.statues[n]["hitbox"], 150):
